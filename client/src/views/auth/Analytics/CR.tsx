    ...
    return (
        <div className="p-6 bg-white rounded shadow max-w-xl mx-auto mt-12">
            <h2 className="text-xl font-bold mb-4">
                Confiscation Receipt Verification
            </h2>
            <div className="mb-4">
                <input
                    type="text"
            ...
            {data && (
                <div className="mt-4 border-t pt-4">
                    <p>
                        <strong>Confiscation (KG):</strong>{' '}
                        {data.total_confiscation}
                    </p>
                    <p>
                        <strong>Receipt Book #:</strong>{' '}
                        {data.receipt_book_number}
                    </p>
                    <p>
                        <strong>Receipt #:</strong> {data.receipt_number}
                    </p>
                    <p>
