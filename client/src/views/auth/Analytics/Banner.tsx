                    ...
                    {[
                        {
                            ...
                            to: '/sign-up?redirectUrl=/spuid-signup',
                        },
                        { label: 'My Applications', to: '/sign-in' },
                        { label: 'Track Application', to: '', action: true },
                        {
                            label: 'MIS - Public Directory',
                            to: '/mis/directory',
                        },
                        {
                            label: 'MIS - Educational Environmental Club Directory',
                            to: '/mis/clubs/directory',
                        },
                    ].map((link, idx) => (
                        <Link
                            key={idx}
            ...
            >
              ...
              <span className="absolute -top-2 -right-2 bg-red-600 text-white text-xs font-bold px-2 py-0.5 rounded-full">
                ...
                <ConfirmDialog
                    ...
                    onConfirm={() => {
                        if (!dialogContent) fetchTrackingInfo()
                ...
                <div className="banned-items mb-4">
                    <h5 className="mb-4">
                        Banned Single-Use Plastic Products under the Punjab
                        Environmental Protection (Production and Consumption of
                        Single-Use Plastic Product) Regulations 2023
                    </h5>
                ...
                <span>
                    In case of any violation found any where, please report at{' '}
                    <a style={{ fontSize: 20 }} href="tel:1374">
                        {' '}
                        <b>1373</b>{' '}
                    </a>
                </span>
            ...
            >
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <img
                            src="/img/flyers/a.jpg"
                            alt="3D Model Competition"
                            className="w-full rounded"
                        />
                        <img
                            src="/img/flyers/b.jpg"
                            alt="Poster Painting Competition"
                            className="w-full rounded"
                        />
                    </div>
