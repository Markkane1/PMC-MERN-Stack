...
const determineCategory = (grade: string) => {
    ...
    return universityGrades.includes(grade)
        ? 'University'
        ...
        <Card>
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                <FormItem label="Auto-detected Category">
                    <Input readOnly value={determineCategory(watch('grade'))} />
                </FormItem>

                <FormItem
                    label="Competition Type *"
                    invalid={Boolean(errors.competitionType)}
                    errorMessage={errors.competitionType?.message}
                >
                    <Controller
                ...
                <FormItem
                    label="Student Card Front *"
                    invalid={Boolean(errors.studentCardFront)}
                    errorMessage={errors.studentCardFront?.message}
                >
                    <Controller
                ...
                <FormItem
                    label={`Photo of your ${getLabel(watch('competitionType'))}`}
                >
                    <Controller
                        name="photoObject"
                        control={control}
