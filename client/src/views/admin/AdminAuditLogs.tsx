...
import AdminService, { AuditLogDto } from '@/services/AdminService'
        ...
        <div className="min-h-[calc(100vh-120px)] bg-slate-50/60 p-6">
            <div className="mx-auto flex max-w-[1400px] flex-col gap-6">
                <div>
                    ...
                    <h3 className="text-2xl font-semibold text-slate-800">Audit Logs</h3>
                    <p className="text-sm text-slate-500">Track login and change history.</p>
                </div>
