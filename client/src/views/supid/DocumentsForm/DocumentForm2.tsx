...
const validationSchema: ZodType<LicenseDetailFormSchema> = z.object({
    ...
    flow_diagram: z
        ...
        .optional() // Ensure the value is a File instance
        .refine(
...
const validationLicenseDetailFieldsConsumerSchema: ZodType<LicenseDetailFormSchema> =
    z.object({
        ...
        productsCapacity: z
            .string()
            .min(1, { message: 'Products Capacity is required' }),
        wasteGenerated: z
            .string()
            .min(1, { message: 'Waste Generated is required' }),
        plasticWasteAcquired: z
            .string()
            .min(1, { message: 'Plastic Waste Acquired is required' }),
    })
...
const validationLicenseDetailFieldsCollectorSchema: ZodType<LicenseDetailFormSchema> =
    z.object({
        ...
        collectorName: z
            .string()
            .min(1, { message: 'Collector Name is required' }),
        collectorCapacity: z.coerce.number().positive({
            message: 'Collector Capacity must be a positive number',
        }),
    })
...
const validationLicenseDetailFieldsProducerSchema: ZodType<LicenseDetailFormSchema> =
    z.object({
        ...
        registration_required_for_other: z.array(z.string()),
        ...
        total_capacity_value: z
            ...
            .optional(),
        total_capacity_unit: z
            .string()
            .min(1, { message: 'Total Capacity Unit is required.' })
            .optional(),
        ...
        registration_date: z
            ...
            .optional(),
        date_of_setting_up: z
            .string()
            .min(1, { message: 'Date of Setting Up is required.' })
            .optional(),
        date_of_commencement_of_production: z
            .string()
            .min(1, {
                message: 'Date of Commencement of Production is required.',
            })
            .optional(),
        flow_diagram: z
        ...
        total_waste_generated_value: z
            ...
            .refine(
                ...
                {
                    message:
                        'Total Waste Generated Value must be a positive number.',
                },
            )
            .optional(),
        total_waste_generated_unit: z
            .string()
            .min(1, { message: 'Total Waste Generated Unit is required.' })
            .optional(),
        ...
        personnel_or_consumers_list: z
            ...
            .refine(
                ...
                {
                    message:
                        'Personnel or Consumers List must be a file smaller than 10 MB.',
                },
            )
            .optional(),
        action_plan: z
