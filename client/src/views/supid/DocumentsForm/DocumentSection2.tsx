...
const LicenseDetailProducerSection = ({
    ...
    const downloadFile = async () => {
        ...
        const response = await AxiosBase.get(
            `/pmc/chalan-pdf?ApplicantId=${applicantDetail.id}`,
            {
                responseType: 'blob', // Important to get the data as a Blob
            },
        )
        ...
        <>
            <Card hidden={true}>
                ...
                <div className="grid md:grid-cols-1 gap-4 mb-1">
                    ...
                    >
                        Please have a look at your application detail prior to
                        generation of fee challan. Once your fee challan is
                        generated, this application will not be amended.
                    </div>
            ...
            <Card>
                <h4 className="mb-4">
                    Submission of Application (Applicable only for previously
                    generated and paid Fee Challans)
                </h4>
                ...
                <div className="grid md:grid-cols-1 gap-4 mb-1">
                    ...
                    >
                        Warning: If any document other than the generated and
                        paid challan is uploaded, it would lead to registration
                        of FIR & arrest of applicant.
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-2">
                    <div>
                        <input
                            ...
                            value={String(
                                applicantDetail.has_fee_challan ?? '',
                            )}
                        />
                        <FormItem
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (file) {
                                                if (
                                                    ...
                                                    alert(
                                                        'Please upload a valid image file (e.g., .jpg, .png)',
                                                    )
            ...
            <Card>
                ...
                <div className="border border-gray-300 bg-gray-50 p-4 rounded-lg shadow-md mb-4">
                    ...
                    <p className="mt-2 text-gray-700">
                        ...
                        button to obtain the PSID. After getting the PSID,
                        follow these steps:
                    </p>
                    <ol className="list-decimal list-inside mt-3 text-gray-600">
                        <li>
                            Open your mobile banking app or mobile payment app.
                        </li>
                        <li>
                            Click on{' '}
                            <strong className="text-blue-600">
                            ...
                            ,{' '}
                            <strong className="text-blue-600">Add Payee</strong>
                            , then select{' '}
                            <strong className="text-blue-600">GoP</strong>.
                        </li>
                        <li>
                            Enter the generated{' '}
                            <strong className="text-blue-600">
                        ...
                        <li>
                            Review your details carefully, save the Payee, and
                            click{' '}
                            <strong className="text-blue-600">Payment</strong>.
                        </li>
                    </ol>
                    <p className="mt-3 text-gray-700">
                        ...
                        in this portal. If the status is not updated, you can
                        click the{' '}
                        <strong className="text-blue-600">
                            Check PSID Payment Status
                        </strong>{' '}
                        button to manually verify.
                    </p>
                    <p className="mt-3 text-gray-700">
                        Once the payment verification is successful, the
                        application will be{' '}
                        <strong className="text-blue-600">
                        ...
                        and come back to this application and page and you can
                        download receipt of submission for your record.
                    </p>

                    <p className="mt-3 text-gray-700">
                        Note: If you have paid fee challan, please don't
                        generate{' '}
                        <strong className="text-blue-600">GoP PSID</strong>,
                        after generation of{' '}
                        <strong className="text-blue-600">GoP PSID</strong> you
                        will not be able to upload existing fee challan.
                    </p>
                </div>
