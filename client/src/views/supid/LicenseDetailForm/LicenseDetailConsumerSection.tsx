...
const LicenseDetailConsumerSection = ({
    control,
    errors,
    readOnly = false,
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            ...
                            >
                                ...
                                <Checkbox value="Others" readOnly={readOnly}>
                                    Others
                                </Checkbox>
                ...
                {registrationRequiredFor.includes('Packaging except food') ? (
                    <div>
                        <FormItem
                            ...
                            invalid={Boolean(
                                errors.plain_plastic_Sheets_for_food_wrapping,
                            )}
                            errorMessage={
                                errors.plain_plastic_Sheets_for_food_wrapping
                                    ?.message
                        ...
                        >
                            <Controller
                                ...
                                render={({ field }) => (
                                    ...
                                    >
                                        <Checkbox
                                            value="Plain Plastic Sheets for food wrapping"
                                            readOnly={readOnly}
                                        >
                                            Plain Plastic Sheets for food
                                            wrapping
                                        </Checkbox>
                                        <Checkbox
                                            value="Other"
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                {w_waste_disposal_provision === 'Yes' && (
                    <FormItem
                        ...
                        errorMessage={
                            errors.no_of_waste_disposible_bins?.message
                        }
                    >
                        <Controller
                ...
                <FormItem
                    ...
                    invalid={Boolean(
                        errors.segregated_plastics_handed_over_to_registered_recyclers,
                    )}
                    errorMessage={
                        errors
