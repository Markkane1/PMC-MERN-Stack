...
const validationLicenseDetailFieldsConsumerSchema: ZodType<LicenseDetailFormSchema> =
    z
        .object({
            registration_required_for: z.array(z.string()).optional(),
            registration_required_for_other: z.array(z.string()).optional(),
            plain_plastic_Sheets_for_food_wrapping: z
                .array(z.string())
                .optional(),
            ...
            provision_waste_disposal_bins: z.enum(['Yes', 'No'], {
                errorMap: () => ({
                    message: 'Please specify provision of waste disposal bins.',
                }),
            }),
            segregated_plastics_handed_over_to_registered_recyclers: z.enum(
                ['Yes', 'No'],
                {
                    errorMap: () => ({
                        message:
                            'Please specify if segregated plastics are handed over to recyclers or collectors.',
                    }),
                },
            ),
            registration_required_for_other_other_text: z.string().optional(),
            no_of_waste_disposible_bins: z.coerce.number().optional(),
        })
        .refine(
            (data) => {
            ...
            {
                message:
                    'You must provide either Categories of Single Use Plastics or Categories for Other Plastics.',
...
const validationLicenseDetailFieldsCollectorSchema: ZodType<LicenseDetailFormSchema> =
    z
        .object({
            licenseType: z
                .string()
                .min(1, { message: 'License Type is required' }),
            ...
            total_capacity_value_collector: z.coerce.number().positive({
                message: 'Collection (Kg per day) must be a positive number',
            }),

            // Validation for number of vehicles
            number_of_vehicles: z.coerce.number().optional(),

            // Validation for number of persons
            number_of_persons: z.coerce.number().optional(),
            registration_required_for_other_other_text: z.string().optional(),
        })
        .refine(
            (data) => {
...
const validationLicenseDetailFieldsProducerSchema: ZodType<LicenseDetailFormSchema> =
    z
        .object({
            registration_required_for: z.array(z.string()).optional(),
            registration_required_for_other: z.array(z.string()).optional(),
            ...
            total_capacity_value: z
                ...
                .refine(
                    ...
                    {
                        message:
                            'Total Capacity Value must be a positive number.',
                    },
                ),
            number_of_machines: z
                .string()
                .min(1, { message: 'Number of Machines are required.' }),
            total_capacity_unit: z.string().optional(),
            registration_number: z.string().optional(),
            registration_date: z.string().optional(),
            date_of_setting_up: z.string().optional(),
            date_of_commencement_of_production: z.string().optional(),
            flow_diagram: z
                ...
                .refine(
                    ...
                    {
                        message:
                            'Flow Diagram must be a file smaller than 10 MB.',
                    },
                )
                .optional(),
            ...
            consent_permit: z
                ...
                .refine(
                    ...
                    {
                        message:
                            'Consent Permit must be a file smaller than 10 MB.',
                    },
                )
                .optional(),
            total_waste_generated_value: z.string().optional(),
            // total_waste_generated_unit: z.string().min(1, { message: 'Total Waste Generated Unit is required.' }).optional(),
            has_waste_storage_capacity: z
                .string()
                .min(1, { message: 'Waste Storage Capacity is required' }),
            waste_disposal_provision: z
                .string()
                .min(1, { message: 'Waste Disposal Provision is required' }),
            ...
            action_plan: z
                ...
                .refine(
                    ...
                    {
                        message:
                            'Action Plan must be a file smaller than 10 MB.',
                    },
                )
                .optional(),
...
const validationLicenseDetailFieldsRecyclerSchema: ZodType<LicenseDetailFormSchema> =
    z.object({
        ...
        selectedCategories: z
            .array(
                z.object({
                    ...
                    wasteCollection: z
                        .string()
                        .min(1, { message: 'Waste Collection is required' }),
                    wasteDisposal: z
                        .string()
                        .min(1, { message: 'Waste Disposal is required' }),
                }),
            )
            .min(1, { message: 'At least one category must be selected' }),
        plastic_waste_acquired_through: z.array(z.string()).optional(),
        has_adequate_pollution_control_systems: z.enum(['Yes', 'No'], {
            errorMap: () => ({
                message:
                    'Please specify whether pollution control systems are adequate',
            }),
        }),
    ...
    const {
        ...
        resolver: zodResolver(
            completedSections.includes('licenseDetailProducer')
                ? validationLicenseDetailFieldsProducerSchema
                : completedSections.includes('licenseDetailConsumer')
                  ? validationLicenseDetailFieldsConsumerSchema
                  : completedSections.includes('licenseDetailCollector')
                    ...
                    : completedSections.includes('licenseDetailRecycler')
                      ? validationLicenseDetailFieldsRecyclerSchema
                      : validationSchema,
        ),
    })
