...
const categories = [
    ...
    { value: 'Packaging except food', label: 'Packaging' },
    {
        ...
        label: 'Plastic Utensils (Box, Bottle, Bin, Bowl, Tray etc.)',
    },
    {
        value: 'Plastic Pipes & Fittings',
        label: 'Plastic Pipes (Flexible, Rigid, etc.) & Fittings',
    },
    { value: 'PET Bottles', label: 'PET Bottles' },
    {
        value: 'Plastic Furniture',
        label: 'Plastic Furniture (Chair, Table etc.)',
    },
    { value: 'Plastic Sheet', label: 'Plastic Sheets & Films' },
    { value: 'Others', label: 'Others' },
]

const LicenseDetailRecyclerSection = ({
    control,
    errors,
    readOnly = false,
        ...
        <Card>
                    ...
                    {categories.map((category) => (
                        ...
                        >
                            <Checkbox
                                ...
                                onChange={(e: boolean) =>
                                    handleCheckboxChange(e, category.value)
                                }
                            >
                                {category.label}
                            </Checkbox>
                                ...
                                <div className="flex gap-2 w-full">
                                    <div className="flex flex-col w-full">
                                        <label className="text-sm text-gray-700">
                                            Average Waste Collection (Kg per
                                            day)
                                        </label>
                                        <Controller
                ...
                >
                    <Controller
                        ...
                        render={({ field }) => (
                            ...
                            >
                                <Checkbox value="Collector" readOnly={readOnly}>
                                    Collector
                                </Checkbox>
                                <Checkbox value="Auction" readOnly={readOnly}>
                                    Auction
                                </Checkbox>
                                <Checkbox value="Contract" readOnly={readOnly}>
                                    Contract
                                </Checkbox>
                                <Checkbox value="Import" readOnly={readOnly}>
                                    Import
                                </Checkbox>
                            </Checkbox.Group>
                        )}
            ...
            <div className="grid md:grid-cols-2 gap-4">
                <FormItem
                    ...
                    invalid={Boolean(
                        errors.has_adequate_pollution_control_systems,
                    )}
                    errorMessage={
                        errors.has_adequate_pollution_control_systems?.message
                    }
                >
                    <Controller
                        name="has_adequate_pollution_control_systems"
