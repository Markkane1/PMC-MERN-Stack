...
const LicenseDetailCollectorSection = ({
    control,
    errors,
    readOnly = false,
        ...
        <Card>
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                    <Controller
                        ...
                        render={({ field }) => (
                            ...
                            >
                                <Checkbox value="Carry bags">
                                    Carry Bags (having thickness not less than
                                    75 micron and not less than 12 x 16 inch in
                                    size)
                                </Checkbox>
                                <Checkbox value="Packaging except food">
                                    Packaging (Multilayered and others) except
                                    food and pharmaceutical products (having
                                    thickness not less than 40 micron)
                                </Checkbox>
                                <Checkbox value="Hospital Products">
                                    Hospital Products & Waste Disposal Bags
                                    (Non-Risk) (having thickness not less than
                                    15 micron)
                                </Checkbox>
                            </Checkbox.Group>
                        )}
                ...
                <FormItem
                    ...
                    errorMessage={
                        errors.registration_required_for_other?.message
                    }
                >
                    <Controller
                        name="registration_required_for_other"
                        ...
                        render={({ field }) => (
                            ...
                            >
                                <Checkbox value="Plastic Utensils">
                                    Plastic Utensils (Box, Bottle, Bin, Bowel,
                                    Tray etc.)
                                </Checkbox>
                                <Checkbox value="Plastic Pipes & Fittings">
                                    Plastic Pipes (Flexible, Rigid, etc.) &
                                    Fittings
                                </Checkbox>
                                <Checkbox value="PET Bottles">
                                    PET Bottles
                                </Checkbox>
                                <Checkbox value="Plastic Furniture">
                                    Plastic Furnitures (Chair, Table etc.)
                                </Checkbox>
                                <Checkbox value="Plastic Sheet">
                                    Plastic Sheets & Films
                                </Checkbox>
                                <Checkbox value="Others">Others</Checkbox>

                                {registration_required_for_other.includes(
                                    'Others',
                                ) && (
                                    <Controller
            ...
            <div className="grid md:grid-cols-2 gap-4">
                <FormItem
                    ...
                    errorMessage={
                        errors.total_capacity_value_collector?.message
                    }
                >
                    <Controller
                ...
                <FormItem
                    ...
                    invalid={Boolean(errors.number_of_persons)}
                    errorMessage={errors.number_of_persons?.message}
                >
                    <Controller
