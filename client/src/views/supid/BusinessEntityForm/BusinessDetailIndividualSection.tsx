...
const BusinessDetailSectionIndividual = ({
    control,
    errors,
    readOnly = false,
    readOnlyDistrict = false,
    ...
    useEffect(() => {
        ...
        const response2 = AxiosBase.get(
            `/pmc/tehsils?district_id=${businessDetailIndividual.district || 0}`,
            {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
    ...
    useEffect(() => {
        if (selectedDistrict) {
            const response = AxiosBase.get(
                `/pmc/tehsils/?district_id=${selectedDistrict}`,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
