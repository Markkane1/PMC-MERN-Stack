...
const validationSchemaBusinessDetail = z.object({
    ...
    registrationNo: z
        ...
        .max(50, {
            message: 'Business Registration Number cannot exceed 50 characters',
        })
        .optional(),
    // ntn: z
    //     .string()
    ...
    workingDays: z
        ...
        .max(365, { message: 'Working Days cannot exceed 365' })
        .optional(),
    commencementDate: z
        .string()
        ...
        .optional(),
    district: z.number().min(1, { message: 'District is required' }).optional(),
    tehsil: z.number().min(1, { message: 'Tehsil is required' }).optional(),
    postalAddress: z
        .string()
        .min(1, { message: 'Postal Address is required' })
        .max(200, { message: 'Postal Address cannot exceed 200 characters' })
        .optional(),
    postalCode: z
        .string()
        .regex(/^\d{5}$/, {
            message: 'Postal Code must be a valid 5-digit number',
        })
        .optional(),
    // latitude: z
    //     .number()
    ...
    const {
        ...
        resolver: zodResolver(
            completedSections.includes('businessDetail')
                ? validationSchemaBusinessDetail
                : completedSections.includes('businessDetailIndividual')
                  ? validationSchemabusinessDetailIndividual
                  : validationSchema,
        ),
    })
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="gap-4 flex flex-col flex-auto">
                        ...
                        <BusinessDetailIndividualSection
                            ...
                            errors={errors}
                            readOnly={readOnly}
                            readOnlyDistrict={readOnlyDistrict}
                        ></BusinessDetailIndividualSection>
                    </div>
                </div>
            </Container>
