...
const ReviewAndSavePage = ({ groupList, children, setMovementDirection }) => {
    ...
    const isAuthorizedDO = userAuthority.some((group) => group === 'DO')
    const isAuthorizedLSM = userAuthority.some((group) => group === 'LSM')
    const isAuthorizedLSM2 = userAuthority.some((group) => group === 'LSM2')
        ...
        if (name === 'previousStage' && checked) {
            ...
            if (isAuthorizedDO) {
                ...
                if (missingComments.length > 0) {
                    alert(
                        "For all fields where 'No' is selected, comments are required.",
                    )
                    return
                }
            }
    ...
    const keyToTitleMapping = {
        ...
        plain_plastic_Sheets_for_food_wrapping:
            'Additional Options for Packaging',
        ...
        segregated_plastics_handed_over_to_registered_recyclers:
            'Whether Segregated Plastics are being handed over to registered Re-Cyclers or Collectors?',
        ...
        // Recycler
        selectedCategories:
            'Categories of plastic collected for recycling (Waste Disposal and Waste Collection in Kg per day)',
        plastic_waste_acquired_through: 'Plastic waste acquired through',
        has_adequate_pollution_control_systems:
            'Has adequate pollution control systems or equipment to meet the standards of emission or effluent?',
                    ...
                    key in keyToTitleMapping ? (
                        ...
                        >
                            ...
                            {!excludedValidationFields.includes(key) && (
                                <div
                                    className="w-full md:flex-[3] flex items-center justify-center space-x-4 mt-2 md:mt-0"
                                    style={{
                                        border: isFieldMissing(key)
                                            ? '2px solid red'
                                            : '',
                                        padding: isFieldMissing(key)
                                            ? '5px'
                                            : '',
                                        borderRadius: isFieldMissing(key)
                                            ? '6px'
                                            : '',
                                    }}
                                >
                            ...
                            <div className="w-full md:flex-[5]">
                                {(fieldResponses[key]?.response === 'Yes' ||
                                    fieldResponses[key]?.response === 'No') && (
                                    <div>
                                        <Input
                                            type="textarea"
                                        ...
                                        />
                                        {/* Validation message */}
                                        {fieldResponses[key]?.response ===
                                            'No' &&
                                            !fieldResponses[key]?.comment && (
                                                <span className="text-red-500 text-sm">
                                                    Comment is required for 'No'
                                                </span>
                                            )}
                                    </div>
                                )}
        ...
        <>
            <Card sx={manualFieldStyles}>
                <CardContent>
                    <Typography
                        variant="h6"
                        sx={{ color: '#007bff', marginBottom: '10px' }}
                    >
                        ...
                        <>
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <FormItem
                                    ...
                                    errorMessage={
                                        errors.listOfByProducts?.message
                                    }
                                >
                                    <Input
                                        type="text"
                                        ...
                                        value={
                                            manualFields.list_of_by_products ||
                                            ''
                                        }
                                        readOnly={disabled}
                                        onChange={(e) =>
                                ...
                                <FormItem
                                    ...
                                    invalid={Boolean(
                                        errors.rawMaterialImported,
                                    )}
                                    errorMessage={
                                        errors.rawMaterialImported?.message
                                    }
                                >
                                    <Input
                                        type="text"
                                        ...
                                        value={
                                            manualFields.raw_material_imported ||
                                            ''
                                        }
                                        readOnly={disabled}
                                        onChange={(e) =>
                                ...
                                <FormItem
                                    ...
                                    invalid={Boolean(
                                        errors.sellerNameIfRawMaterialBought,
                                    )}
                                    errorMessage={
                                        errors.sellerNameIfRawMaterialBought
                                            ?.message
                                ...
                                >
                                    <Input
                                        ...
                                        value={
                                            manualFields.seller_name_if_raw_material_bought ||
                                            ''
                                        }
                                        readOnly={disabled}
                                        onChange={(e) =>
                                ...
                                <FormItem
                                    ...
                                    errorMessage={
                                        errors.selfImportDetails?.message
                                    }
                                >
                                    <Input
                                        type="text"
                                        ...
                                        value={
                                            manualFields.self_import_details ||
                                            ''
                                        }
                                        readOnly={disabled}
                                        onChange={(e) =>
                                ...
                                <FormItem
                                    ...
                                    invalid={Boolean(
                                        errors.rawMaterialUtilized,
                                    )}
                                    errorMessage={
                                        errors.rawMaterialUtilized?.message
                                    }
                                >
                                    <Input
                                        type="text"
                                        ...
                                        value={
                                            manualFields.raw_material_utilized ||
                                            ''
                                        }
                                        readOnly={disabled}
                                        onChange={(e) =>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <FormItem
                                    ...
                                    invalid={Boolean(
                                        errors.complianceThickness75,
                                    )}
                                    errorMessage={
                                        errors.complianceThickness75?.message
                                    }
                                >
                                    <div>
                                        <label className="flex items-center space-x-2">
                                            <input
                                                ...
                                                value="Yes"
                                                checked={
                                                    manualFields.compliance_thickness_75 ===
                                                    'Yes'
                                                }
                                                disabled={disabled}
                                                onChange={() =>
                                                    handleChangeManualFields(
                                                        'compliance_thickness_75',
                                                        'Yes',
                                                    )
                                                }
                                            />
                                ...
                                <FormItem
                                    ...
                                    invalid={Boolean(
                                        errors.validConsentPermitBuildingBylaws,
                                    )}
                                    errorMessage={
                                        errors.validConsentPermitBuildingBylaws
                                            ?.message
                                    ...
                                    <div>
                                        <label className="flex items-center space-x-2">
                                            <input
                                                ...
                                                value="Yes"
                                                checked={
                                                    manualFields.valid_consent_permit_building_bylaws ===
                                                    'Yes'
                                                }
                                                disabled={disabled}
                                                onChange={() =>
                                ...
                                <FormItem
                                    ...
                                    errorMessage={
                                        errors.consentPermitFile?.message
                                    }
                                >
                                    <Input
                                        type="file"
                                ...
                                <FormItem
                                    ...
                                    errorMessage={
                                        errors.flowDiagramFile?.message
                                    }
                                >
                                    <Input
                                        type="file"
                                ...
                                <FormItem
                                    ...
                                    invalid={Boolean(
                                        errors.stockistDistributorList,
                                    )}
                                    errorMessage={
                                        errors.stockistDistributorList?.message
                                    }
                                >
                                    <Input
                                        type="text"
                                        ...
                                        value={
                                            manualFields.stockist_distributor_list ||
                                            ''
                                        }
                                        readOnly={disabled}
                                        onChange={(e) =>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            ...
                            >
                                <Input
                                    ...
                                    value={
                                        manualFields.procurement_per_day || ''
                                    }
                                    readOnly={disabled}
                                    onChange={(e) =>
                                        handleChangeManualFields(
                    ...
                    {licenseDetail.licenseType === 'Recycler' && (
                        <div className="grid md:grid-cols-2 gap-4">
                            ...
                            <FormItem
                                ...
                                invalid={Boolean(
                                    errors.laborDeptRegistrationStatus,
                                )}
                                errorMessage={
                                    errors.laborDeptRegistrationStatus?.message
                                }
                            >
                                <div>
                                    <label className="flex items-center space-x-2">
                                        <input
                                            ...
                                            onChange={() => {
                                                handleChangeManualFields(
                                                    'labor_dept_registration_status',
                                                    'Yes',
                                                )
                            ...
                            <FormItem
                                ...
                                invalid={Boolean(
                                    errors.occupationalSafetyAndHealthFacilities,
                                )}
                                errorMessage={
                                    errors.occupationalSafetyAndHealthFacilities
                                        ?.message
                            ...
                            >
                                <Input
                                    ...
                                    value={
                                        manualFields.occupational_safety_and_health_facilities ||
                                        ''
                                    }
                                    readOnly={disabled}
                                    onChange={(e) =>
                            ...
                            <FormItem
                                ...
                                invalid={Boolean(
                                    errors.adverseEnvironmentalImpacts,
                                )}
                                errorMessage={
                                    errors.adverseEnvironmentalImpacts?.message
                                }
                            >
                                <Input
                                    type="text"
                                    ...
                                    value={
                                        manualFields.adverse_environmental_impacts ||
                                        ''
                                    }
                                    readOnly={disabled}
                                    onChange={(e) =>
                        ...
                        laborDeptRegistered && (
                            <Card sx={manualFieldStyles}>
                                <CardContent>
                                    ...
                                    >
                                        Upload 'Registration with Labor
                                        Department' Document
                                    </Typography>
                                    ...
                                    <FormItem
                                        ...
                                        invalid={Boolean(
                                            errors.registrationWithLaborDept,
                                        )}
                                        errorMessage={
                                            errors.registrationWithLaborDept
                                                ?.message
                ...
                <Card sx={manualFieldStyles}>
                    <CardContent>
                        <Typography
                            ...
                            sx={{ color: '#007bff', marginBottom: '10px' }}
                        >
                            Information to be provided by License Support
                            Manager
                        </Typography>
                            ...
                            <div className="flex flex-col mb-4">
                                ...
                                <div className="flex items-center space-x-4">
                                    <label className="flex items-center">
                                        ...
                                        />
                                        Fee Verification from Treasury/District
                                        Accounts Office
                                    </label>
                                    <label className="flex items-center">
                                        <input
                ...
                {!disabled && (
                    <Card className="mb-4">
                        <CardContent>
                            ...
                            >
                                Please review the information provided by the
                                applicant. This information is not editable and
                                it is for your review only. Please click "Yes"
                                if information is found correct and "No" if
                                information is not correct. In case of "No"
                                pleae add your comments too.
                            </Typography>
                        </CardContent>
                    </Card>
                )}
                {disabled && (
                    <Card className="mb-4">
                        <CardContent>
                            ...
                            >
                                Please review the information provided by the
                                applicant and District Incharge.
                            </Typography>
                        </CardContent>
                    </Card>
                )}
                                ...
                                <FormControl>
                                    ...
                                    >
                                        ...
                                        <Typography variant="body2">
                                            Please select any of the below
                                            actions:
                                        </Typography>
                                    </Box>
                                    <FormControlLabel
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Checkbox
                                                name="previousStage"
                                                checked={
                                                    checkboxState.previousStage
                                                }
                                                onChange={handleCheckboxChange}
                                            />
                                        }
                                        label={`No - As per the remarks and verification, please proceed to the previous stage for preliminary scrutiny/data entry, etc. ${
                                            groupList[1]?.label === 'DO'
                                                ? ''
                                                : '(' +
                                                  groupList[0]?.label +
                                                  ')'
            ...
            >
                <p>
                    ...
                    <ol className="list-decimal pl-6">
                        <li>
                            establish a system for collection of the plastic
                            waste generated due to his products within a period
                            of six months from the commencement of the
                            regulations;
                        </li>
                        <li>
                            ensure that the minimum requirement of twenty
                            percent mixing of recycled material shall be met in
                            production of single-use plastic product along with
                            virgin material;
                        </li>
                        <li>
                            carry out awareness campaigns regarding proper
                            disposal of single-use plastic product which may
                            include, but not limited to, displaying educative
                            slogans, or messages, etc.; and
                        </li>
                        <li>
                            perform other function as notified by the Agency for
