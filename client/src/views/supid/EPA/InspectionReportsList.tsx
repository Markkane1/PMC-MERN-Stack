...
const InspectionReportsList = () => {
    ...
    const columns = [
        ...
        {
            accessorKey: 'total_confiscation',
            header: 'Total Confiscation (KG)',
            size: 200,
        },
    ...
    const downloadExcel = async () => {
        try {
            const response = await AxiosBase.get(
                '/pmc/inspection-report/export-all-inspections-excel/',
                {
    ...
    const downloadPDF = async () => {
        try {
            const response = await AxiosBase.get(
                '/pmc/inspection-report/export-all-inspections-pdf/',
                {
                    responseType: 'blob', // Important to get binary data
                },
            )
