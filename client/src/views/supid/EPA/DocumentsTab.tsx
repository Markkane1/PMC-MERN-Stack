...
const documentSchema = z.object({
    ...
    documentType: z.enum(['Notification', 'Minutes of Meeting'], {
        required_error: 'Select a document type',
    }),
    file: z.instanceof(File, { message: 'Must be a valid file' }).optional(),
                ...
                return (
                    <Tooltip title="Download Document">
                        <IconButton
                            sx={{
                                background:
                                    'linear-gradient(135deg, #007BFF, #0056b3)', // VIP Blue Gradient
                                color: '#fff',
                                ...
                                '&:hover': {
                                    background:
                                        'linear-gradient(135deg, #0056b3, #007BFF)', // Reversed hover effect
