...
const ClubDirectory = () => {
    ...
    return (
        <div className="flex flex-col p-4 gap-4">
            {showNotice && (
                <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded relative">
                    <p className="font-medium">
                        ...
                        please click on the School Name.
                    </p>
                    <button
            ...
            <Modal
                open={!!selectedClub}
                aria-labelledby="club-details-modal"
                            ...
                            <>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        {selectedClub.head_name}
                                    </p>
                                    <p className="text-gray-600">
                                        <span className="font-semibold text-gray-900">
                                            Head Mobile:
                                        </span>{' '}
                                        {selectedClub.head_mobile}
                                    </p>
                                    ...
                                    {selectedClub.notification_path && (
                                        <div className="flex items-center space-x-2 border-t pt-3">
                                            <TablerIcon
                                                ...
                                                onClick={() =>
                                                    window.open(
                                                        `/api/pmc/media${selectedClub.notification_path}`,
                                                        '_blank',
                                                    )
                                                }
                                            />
