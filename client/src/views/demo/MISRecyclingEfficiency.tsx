...
const tileDefs = [
    ...
    },
    {
        key: 'Distributed',
        bgColor: 'bg-blue-500',
        icon: <TablerIcon name="user" className="text-white text-3xl" />,
    ...
    },
    {
        key: 'Un-Managed',
        bgColor: 'bg-gray-500',
        icon: <TablerIcon name="chart-bar" className="text-white text-3xl" />,
...
const MISDirectory = () => {
    ...
    const [DEFAULT_CENTER, setDefaultCenter] = useState([
        8054803.349056441, 3623248.3407283584,
    ])
        ...
        <ul className="list-disc pl-4 mt-2">
          ...
          <li><span style={{ color: '#008000' }}>■</span> Dark Green (80-100%): Excellent Efficiency</li>
            ...
            <Dialog open={modalInfo.open} onClose={closeModal}>
                        ...
                        <div className="mt-2">
                            ...
                            <ul className="list-disc pl-4 mt-2">
                                <li>
                                    ...
                                    Tomato Red (0%): Critical
                                </li>
                                <li>
                                    <span style={{ color: '#FFA500' }}>■</span>{' '}
                                    Orange (1-19%): Very Low Efficiency
                                </li>
                                <li>
                                    <span style={{ color: '#90EE90' }}>■</span>{' '}
                                    Light Green (20-49%): Moderate Efficiency
                                </li>
                                <li>
                                    <span style={{ color: '#22C55E' }}>■</span>{' '}
                                    Medium Green (50-79%): Good Efficiency
                                </li>
                                <li>
                                    <span style={{ color: '#008000' }}>■</span>{' '}
                                    Dark Green (80-100%): Excellent Efficiency
                                </li>
                            </ul>
                        </div>
                    )}
                ...
                <DialogActions>
                    <Button autoFocus variant="contained" onClick={closeModal}>
                        OK
                    </Button>
                </DialogActions>
            </Dialog>
...
const categoryIconMap = {
    ...
    Distributor: <TablerIcon name="user" className="text-xl" />,
    Collector: <TablerIcon name="truck" className="text-xl" />,
    Recycler: <TablerIcon name="recycle" className="text-xl" />,
}
                ...
                Header: ({ column }: any) => (
                    <div className="flex items-center">
                        ...
                        <TablerIcon
                            ...
                            onClick={() =>
                                openModal('Produced', tileDefs[0].info)
                            }
                        />
                    </div>
                ),
                ...
                Header: () => (
                    <div className="flex items-center">
                        ...
                        <TablerIcon
                            ...
                            className="ml-1 cursor-pointer text-blue-500"
                            onClick={() =>
                                openModal('Collected', tileDefs[2].info)
                            }
                        />
                    </div>
                ),
