...
} from '../../views/supid/BusinessEntityForm/types'
import type {
    LicenseDetailFields,
...
} from '../../views/supid/LicenseDetailForm/types'
...
type FormStore = {
    ...
    updateBusinessDetailIndividual: (
        data: Partial<BusinessDetailIndividualFields>,
    ) => void
...
const useFormStore = create<FormStore>((set, get) => ({
    ...
    updateApplicantDetail: (data) =>
        set((state) => ({
            ...
            completedSections: state.completedSections.includes(
                'applicantDetail',
            )
    ...
    resetApplicantDetail: () =>
        set((state) => ({
            ...
            completedSections: state.completedSections.filter(
                (section) => section !== 'applicantDetail',
            ),
        })),
    ...
    resetBusinessDetail: () =>
        set((state) => ({
            ...
            completedSections: state.completedSections.filter(
                (section) => section !== 'businessDetail',
            ),
        })),
    ...
    updateBusinessDetailIndividual: (data) =>
        set((state) => ({
            businessDetailIndividual: {
                ...state.businessDetailIndividual,
                ...data,
            },
            completedSections: state.completedSections.includes(
                'businessDetailIndividual',
    ...
    resetBusinessDetailIndividual: () =>
        set((state) => ({
            ...
            completedSections: state.completedSections.filter(
                (section) => section !== 'businessDetailIndividual',
            ),
        })),
    ...
    resetBusinessEntity: () =>
        set((state) => ({
            ...
            completedSections: state.completedSections.filter(
                (section) => section !== 'businessEntity',
            ),
        })),
    ...
    resetLicenseDetailProducer: () =>
        set((state) => ({
            ...
            completedSections: state.completedSections.filter(
                (section) => section !== 'licenseDetailProducer',
            ),
        })),
