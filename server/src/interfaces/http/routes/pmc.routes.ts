...
pmcRouter.get('/alerts/:alertId([0-9a-fA-F]{24})', authenticate, alertUseCases.getAlertDetails)
pmcRouter.put('/alerts/:alertId([0-9a-fA-F]{24})/read', authenticate, alertUseCases.markAlertAsRead)
pmcRouter.put('/alerts/mark-read/batch', authenticate, alertUseCases.markMultipleAsRead)
pmcRouter.delete('/alerts/:alertId([0-9a-fA-F]{24})', authenticate, alertUseCases.deleteAlert)
